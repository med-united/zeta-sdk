...
abstract class BaseSmcbTokenProvider : SubjectTokenProvider {
    protected abstract suspend fun readCertificate(): ByteArray
    protected abstract suspend fun externalAuthenticate(base64Challenge: String): ByteArray
    ...
    override suspend fun createSubjectToken(
        ...
        val smbcCertificate = readCertificate()
    ...
    private suspend fun signSmcbToken(token: String): String {
        ...
        val signatureBytes = externalAuthenticate(challenge)
        val signature = derEcdsaToJose(signatureBytes, 32)
